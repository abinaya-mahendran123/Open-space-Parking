...
class MongoDataService {
  ...
  Future<PaginatedResult<Map<String, dynamic>>> findPaginated({
    ...
    if (_httpService != null) {
      return _httpService!.findPaginated(
        collectionName: collectionName,
        query: query,
      );
    }
  ...
  Future<bool> updateById({
    ...
    if (_httpService != null) {
      return _httpService!.updateById(
        collectionName: collectionName,
        id: id,
        updates: updates,
      );
  ...
  Future<bool> softDelete({
    ...
    if (_httpService != null) {
      return _httpService!.softDelete(
        collectionName: collectionName,
        id: id,
      );
    }
  ...
  Future<bool> hardDelete({
    ...
    if (_httpService != null) {
      return _httpService!.hardDelete(
        collectionName: collectionName,
        id: id,
      );
    }
  ...
  Future<void> ensureIndexes({
    ...
    if (_httpService != null) {
      return _httpService!.ensureIndexes(
        collectionName: collectionName,
        indexes: indexes,
      );
    }
