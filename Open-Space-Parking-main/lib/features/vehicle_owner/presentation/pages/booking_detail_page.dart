            ...
            child: Column(
              ...
              children: [
                ...
                _DetailTile(
                  icon: Icons.schedule,
                  label: 'Start',
                  value: dateFormat.format(booking.startDateTime.toLocal()),
                ),
                _DetailTile(
                  icon: Icons.schedule,
                  label: 'End',
                  value: dateFormat.format(booking.endDateTime.toLocal()),
                ),
                _DetailTile(
                ...
                if (booking.hasQr &&
                    (booking.isParked || booking.isAwaitingPayment)) ...[
                  FilledButton.icon(
                ...
                if (booking.isAwaitingPayment) ...[
                  PrimaryButton(
                    label:
                        'Pay ₹${booking.amountDue!.toStringAsFixed(0)} & Checkout',
                    onPressed: () => context.push(
                ...
                if (canCancel && !booking.isParked && !booking.isAwaitingPayment) ...[
