...
2. Add Android/iOS/Web apps (`com.estar.openspaceparking`)
...
1. Firebase Console → Project **open-space-parking** → Project settings → Your apps → Android (`com.estar.openspaceparking`)
