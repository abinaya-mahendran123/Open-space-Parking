...
abstract class VehicleOwnerRepository {
  ...
  /// Walk-in: FCFS slot + QR. Session starts only after security QR scan.
  ...
  /// Security dual scan: first scan starts session, second scan stops & bills.
  Future<Booking> scanParkingQr(String qrPayload);
