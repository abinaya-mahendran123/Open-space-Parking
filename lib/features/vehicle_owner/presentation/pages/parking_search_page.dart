                ...
                if (listings.isEmpty) {
                  return Center(
                    child: Padding(
                      ...
                      child: Text(
                        hasLocation
                            ? 'No parking found near you yet. Verified sites with GPS will appear here.'
                            : 'No parking listed yet. Verified parking with a location will show here. You can also tap Current Location to sort by distance.',
